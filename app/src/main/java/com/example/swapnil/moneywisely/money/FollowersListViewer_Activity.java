...
public class FollowersListViewer_Activity extends AppCompatActivity {
    ...
    String str_success, str_title, str_link, str_mesg, str_userID, str_fid;

    PrefManager manager;
    SharedPreferences pref_view;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_followers_list_viewer);
    ...
    private class GetFollowers extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(FollowersListViewer_Activity.this);
                    ...
                    public void onResponse(Call call, final Response response) throws IOException {
                        if (response != null) {
                                ...
                                public void run() {
                                    try {
                                        ...
                                        if (str_success.equals("1")) {
                                            ...
                                            followerAdapter = new FollowerAdapter(FollowersListViewer_Activity.this, followerList);
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(FollowersListViewer_Activity.this);
