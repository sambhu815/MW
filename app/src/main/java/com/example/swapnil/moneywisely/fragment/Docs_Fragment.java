...
public class Docs_Fragment extends Fragment {
    public static final String TAG = Docs_Fragment.class.getSimpleName();
    ...
    private class GetDocs extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(final String... strings) {
            try {
                ...
                request = new Request.Builder().url(AppConstant.getDocuments).post(reqbody).build();
                                    ...
                                    try {
                                        ...
                                        if (str_success.equals("1")) {
                                            ...
                                            for (int i = 0; i < jsondata.length(); i++) {
                                                ...
                                                market.put(AppConstant.TAG_document_title, object.getString(AppConstant.TAG_document_title));
                                                market.put(AppConstant.TAG_document_desc, object.getString(AppConstant.TAG_document_desc));
                                                market.put(AppConstant.TAG_document_image, object.getString(AppConstant.TAG_document_image));
                                                market.put(AppConstant.TAG_documentlink, object.getString(AppConstant.TAG_documentlink));

                                                marketList.add(market);
                                            }
                                            marketAdapter = new MarketAdapter(activity, marketList, "docs");
                                            list_docs.setAdapter(marketAdapter);
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Snackbar.make(activity.findViewById(android.R.id.content), "Permission Denied, Please allow to proceed !", Snackbar.LENGTH_LONG).show();
                }
                break;
        }
    }
