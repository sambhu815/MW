...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.RecyclerViewHolder> {
    ...
    SharedPreferences.Editor editor, editor_image;
    ArrayList<HashMap<String, String>> postList;
    ArrayList<Integer> dataLike, likecount, markoff;
    private Context context;

    public PostAdapter(Context context, ArrayList<HashMap<String, String>> postList, ArrayList<Integer> dataLike, ArrayList<Integer> likecount, ArrayList<Integer> markoff) {
        ...
        holder.iv_post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (holder.str_type.equals("image")) {
                    ...
                    editor_image.putString("name", holder.str_name + "'s Post");
                    editor_image.putString("img", holder.str_postImg);
                    editor_image.putString("back", "post");
                    editor_image.commit();
