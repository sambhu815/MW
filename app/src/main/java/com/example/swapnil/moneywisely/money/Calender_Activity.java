...
public class Calender_Activity extends AppCompatActivity {
    public static final String TAG = Calender_Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Calender and Economics");
        ...
        list_calender = (ListView) findViewById(R.id.list_calender);

        if (support.checkInternetConnectivity()) {
            new GetCalender().execute();
        } else {
    ...
    private class GetCalender extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(Calender_Activity.this);
        ...
        protected String doInBackground(final String... strings) {
            try {
                ...
                request = new Request.Builder().url(AppConstant.getCalendar).post(reqbody).build();
                    ...
                    public void onResponse(Call call, final Response response) throws IOException {
                        if (response != null) {
                                    ...
                                    try {
                                        ...
                                        if (str_success.equals("1")) {
                                            ...
                                            for (int i = 0; i < jsondata.length(); i++) {
                                                ...
                                                str_title = object.getString(AppConstant.TAG_calendar_title);
                                                str_link = object.getString(AppConstant.TAG_calendar_link);
                                                str_image = object.getString(AppConstant.TAG_calendar_img);

                                                HashMap<String, String> market = new HashMap<String, String>();
                                                market.put(AppConstant.TAG_calendar_title, str_title);
                                                market.put(AppConstant.TAG_calendar_link, str_link);
                                                market.put(AppConstant.TAG_calendar_img, str_image);
                                                market.put(AppConstant.TAG_calendar_desc, object.getString(AppConstant.TAG_calendar_desc));

                                                marketList.add(market);
                                            }
                                            marketAdapter = new MarketAdapter(Calender_Activity.this, marketList, "calender");
                                            list_calender.setAdapter(marketAdapter);
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Calender_Activity.this);
