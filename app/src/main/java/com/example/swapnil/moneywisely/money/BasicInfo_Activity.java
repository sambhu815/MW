...
public class BasicInfo_Activity extends AppCompatActivity {
    public static final String TAG = BasicInfo_Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_basic = (ListView) findViewById(R.id.list_basic);
    ...
    private class GetBasicinfo extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(BasicInfo_Activity.this);
        ...
        protected String doInBackground(final String... strings) {
            try {
                ...
                request = new Request.Builder().url(AppConstant.getBasicinfo).post(reqbody).build();
                    ...
                    public void onResponse(Call call, final Response response) throws IOException {
                        if (response != null) {
                                    ...
                                    try {
                                        ...
                                        if (str_success.equals("1")) {
                                            ...
                                            for (int i = 0; i < jsondata.length(); i++) {
                                                ...
                                                str_title = object.getString(AppConstant.TAG_basicinfo_title);
                                                str_link = object.getString(AppConstant.TAG_basicinfo_desc);
                                                str_image = object.getString(AppConstant.TAG_basicinfo_class);

                                                HashMap<String, String> market = new HashMap<String, String>();
                                                market.put(AppConstant.TAG_basicinfo_title, str_title);
                                                market.put(AppConstant.TAG_basicinfo_desc, str_link);
                                                market.put(AppConstant.TAG_basicinfo_class, str_image);
                                                marketList.add(market);
                                            }
                                            marketAdapter = new MarketAdapter(BasicInfo_Activity.this, marketList, "basic");
                                            list_basic.setAdapter(marketAdapter);
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(BasicInfo_Activity.this);
