...
public class PersonalandOther_Activity extends AppCompatActivity {
    public static final String TAG = PersonalandOther_Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personaland_other);
        ...
        getSupportActionBar().setTitle("Personal Links");
        ...
        if (support.checkInternetConnectivity()) {
            new GetPersonalandOther().execute();
        } else {
    ...
    private class GetPersonalandOther extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pd = new ProgressDialog(PersonalandOther_Activity.this);
        ...
        protected String doInBackground(final String... strings) {
            try {
                ...
                request = new Request.Builder().url(AppConstant.getPersonalandOtherLinks).post(reqbody).build();
                    ...
                    public void onResponse(Call call, final Response response) throws IOException {
                        if (response != null) {
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    try {
                                        ...
                                        Log.e("getPersonalandOther ->", "" + jsonObject);
                                        ...
                                        if (str_success.equals("1")) {
                                            ...
                                            for (int i = 0; i < jsondata.length(); i++) {
                                                ...
                                                str_title = object.getString(AppConstant.TAG_otherlinks_title);
                                                str_link = object.getString(AppConstant.TAG_otherlinks_link);
                                                str_image = object.getString(AppConstant.TAG_otherlinks_image);

                                                HashMap<String, String> market = new HashMap<String, String>();
                                                market.put(AppConstant.TAG_otherlinks_title, str_title);
                                                market.put(AppConstant.TAG_otherlinks_link, str_link);
                                                market.put(AppConstant.TAG_otherlinks_image, str_image);
                                                market.put(AppConstant.TAG_otherlinks_desc, object.getString(AppConstant.TAG_otherlinks_desc));

                                                marketList.add(market);
                                            }
                                            marketAdapter = new MarketAdapter(PersonalandOther_Activity.this, marketList, "personal");
                                            list_personal.setAdapter(marketAdapter);
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(PersonalandOther_Activity.this);
